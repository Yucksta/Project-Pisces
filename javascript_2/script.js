console.log("Code is running. Running where? I don't know.");
    ...
    if (done206[0] == false){
        ...
        while (countvariablethatalsoneedstobethisway < 100000) {
            ...
            if (countvariablethatalsoneedstobethisway % 1300 != 0 && countvariablethatalsoneedstobethisway % 294 != 0){
                setTimeout(ComputerFrameUpdatingSoftwareDesignedToRepresentTheIllusionOfChioce, countvariablethatalsoneedstobethisway * 2.5);
            }
            else if (countvariablethatalsoneedstobethisway == 2009 || countvariablethatalsoneedstobethisway == 17) {
                //this is not getting ran 01060032 01170058
                break
        ...
        console.error("Data extraction complete; the following state id's have been purged: " + Atleast1iteratedarraywithaccessedandusedelementsinit);
    }
 }